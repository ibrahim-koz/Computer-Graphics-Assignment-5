...
obj_utils.downloadMeshes = function( nameAndURLs, completionCallback, numCopiesOfMeshes, textureIDs, callbackFunction){
    ...
    $.when.apply( $, ajaxes ).done(function(){
        completionCallback( meshes, boundRenderingContext.gl, boundContainer, numCopiesOfMeshes, textureIDs, callbackFunction);
    });
}
